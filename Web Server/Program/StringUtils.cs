...
namespace Program {
	...
	public class StringUtils {
		...
		public static short ParseShort(string number) {
			try {
				return Int16.Parse(ToNumberFormat(number), CultureInfo.InvariantCulture.NumberFormat);
		...
		public static int ParseInt(string number) {
			try {
				return Int32.Parse(ToNumberFormat(number), CultureInfo.InvariantCulture.NumberFormat);
			} catch (FormatException) { }
			return 0;
		}
		...
		public static long ParseLong(string number) {
			try {
				return Int64.Parse(ToNumberFormat(number), CultureInfo.InvariantCulture.NumberFormat);
			} catch (FormatException) { }
			return 0L;
		}
		...
		public static float ParseFloat(string number) {
			try {
				return Single.Parse(ToNumberFormat(number), CultureInfo.InvariantCulture.NumberFormat);
			} catch (FormatException) { }
			return 0F;
		}
